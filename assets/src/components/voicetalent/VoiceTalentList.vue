<template>
    <div class="container my-5">
        <div class="flex justify-between mb-6 px-6 container">
            <h3 class="text-blue-600 text-xl font-bold py-2 px-4 m-2">Registered Talents</h3>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapGetters('VoiceTalentList', ['data', 'total', 'errorMsg', 'successMsg', 'currentPage', 'pageSize']),
        },
        methods: {
