...
const actions = {
    ...
    insertPlatform({ commit, state, dispatch }) {
        ...
        axios.post("/wp-json/vtm/v1/insert-platform", formData, config)
            .then(
                function(response) {
                    if (response.data.error) {
    ...
    updatePlatform({ commit, state, dispatch }) {
        ...
        axios.post("/wp-json/vtm/v1/update-platform", formData, config)
            .then(
                function(response) {
                    if (response.data.error) {
                        app.errorMsg = response.data.message;
    ...
    deletePlatform({ commit, state, dispatch }) {
        ...
        axios.post("/wp-json/vtm/v1/delete-platform", formData, config)
            .then(
                function(response) {
                    if (response.data.error) {
                        app.errorMsg = response.data.message;
