...
const actions = {
    ...
    insertAccent({ commit, state, dispatch }) {
        ...
        axios.post("/wp-json/vtm/v1/insert-accent", formData, config)
            .then(
                function(response) {
                    if (response.data.error) {
    ...
    updateAccent({ commit, state, dispatch }) {
        ...
        axios.post("/wp-json/vtm/v1/update-accent", formData, config)
            .then(
                function(response) {
                    if (response.data.error) {
                        app.errorMsg = response.data.message;
    ...
    deleteAccent({ commit, state, dispatch }) {
        ...
        axios.post("/wp-json/vtm/v1/delete-accent", formData, config)
            .then(
                function(response) {
                    if (response.data.error) {
                        app.errorMsg = response.data.message;
